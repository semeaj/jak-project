...
(cgo-file "jgx.gd" common-dep) ;; jungle shared prop art (actor code objects dropped, see jgx.gd)
...
(cgo-file "junglew.gd" common-dep) ;; persistent track-wide jungle level (code objects dropped, see junglew.gd)
