...
(cgo-file "jgx.gd" common-dep) ;; jungle shared prop art (jungle-obs.o still dropped, see jgx.gd)
...
(cgo-file "junglew.gd" common-dep) ;; persistent track-wide jungle level (jungle-obs.o still dropped, see junglew.gd)
