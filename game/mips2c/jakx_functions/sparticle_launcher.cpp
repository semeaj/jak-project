...
u64 execute(void* ctxt) {
  ...
  c->fprs[f3] = c->fprs[f3] * c->fprs[f3] + c->fprs[f4] * c->fprs[f4]; // mula.s f3, f3 + madd.s f3, f4, f4
  ...
  c->fprs[f0] = c->fprs[f0] * c->fprs[f3] + c->fprs[f2] * c->fprs[f5]; // mula.s f0, f3 + madd.s f0, f2, f5
