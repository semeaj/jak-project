...
// add draw_large_polygon_ocean::link to the link callback table for the object file.
// FWD DEC:
...
// add init_ocean_far_regs::link to the link callback table for the object file.
// FWD DEC:
